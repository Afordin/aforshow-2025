...
import { checkUserSubscriptionByTwitchId } from "@/services/twitch/subscriptions";
          ...
          <div style="flex: 2; display: flex; flex-direction: column; justify-content: space-between;">
            <div style="display: flex; align-items: center; gap: 20px;">
              ...
              <div style="display: flex; flex-direction: column;">
                ...
                ${
									isSubscribed
										? `<div style="display: flex; align-items: center; width: 64px; height: 21px; background-color: #F43E71; padding: 2px 4px; border-radius: 32px; gap: 8px;">
                          <img src="https://afor.show/svgs/Twitch.svg" aria-hidden="true" alt="Twitch Logo" width="12" height="13" />
                          <span style="font-size: 12px; font-weight: 700; color: #fff;">Sub</span>
                        </div>`
										: ""
								}
              </div>
